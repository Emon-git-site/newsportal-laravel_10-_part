                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="title_bn" name="title_bn"
                                                value="{{ old('title_bn') }}" placeholder="Enter Bangla Title">
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="tags_bn" name="tags_bn"
                                                value="{{ old('tags_bn') }}"" placeholder="Enter Bangla Title">
                                        </div>

                                        <div class="form-group col-md-6">
                                            <label for="tags_en">Tag English</label>
                                            <input type="text" class="form-control" id="tags_en" name="tags_en"
                                                value="{{ old('tags_en') }}" placeholder="Enter English title">
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label for="details_bangla">Details Bangla</label>
                                        <textarea class="summernote" name="details_bn"> {{ old('details_bn') }}
                                          </textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="details_english">Details English</label>
                                        <textarea class="summernote" name="details_en">{{ old('details_en') }}
                                           </textarea>
                                    </div>
